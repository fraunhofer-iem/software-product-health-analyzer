...
<picture>
<source media="(prefers-color-scheme: dark)" srcset="../fix-repo-files/docs/img/IEM_Logo_White.png">
<img alt="Logo IEM" src="../fix-repo-files/docs/img/IEM_Logo_Dark.png">
</picture>
